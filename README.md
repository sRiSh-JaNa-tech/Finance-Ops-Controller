...
> For deep-dive architectural decisions and competition slide presentation blueprint, see [`ARCHITECTURE_AND_SYSTEM_DESIGN.md`](ARCHITECTURE_AND_SYSTEM_DESIGN.md).
